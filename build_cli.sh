...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/TERRA-TECH-SYSTEMS/codex/refs/heads/main/versions"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/TERRA-TECH-SYSTEMS/codex/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/TERRA-TECH-SYSTEMS/codex/releases"
fi
