...
setpath "product" "licenseUrl" "https://github.com/TERRA-TECH-SYSTEMS/codex/blob/main/LICENSE"
setpath_json "product" "linkProtectionTrustedDomains" '["https://open-vsx.org", "https://*.terratech.systems", "https://*.ageixtic.ai"]'
setpath "product" "releaseNotesUrl" "https://github.com/TERRA-TECH-SYSTEMS/codex/releases"
setpath "product" "reportIssueUrl" "https://github.com/TERRA-TECH-SYSTEMS/codex/issues/new"
setpath "product" "requestFeatureUrl" "https://go.microsoft.com/fwlink/?LinkID=533482"
setpath "product" "tipsAndTricksUrl" "https://go.microsoft.com/fwlink/?linkid=852118"
setpath "product" "twitterUrl" "https://go.microsoft.com/fwlink/?LinkID=533687"

if [[ "${DISABLE_UPDATE}" != "yes" ]]; then
  setpath "product" "updateUrl" "https://raw.githubusercontent.com/TERRA-TECH-SYSTEMS/codex-versions/refs/heads/main"

  if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
    setpath "product" "downloadUrl" "https://github.com/TERRA-TECH-SYSTEMS/codex/releases"
  else
    setpath "product" "downloadUrl" "https://github.com/TERRA-TECH-SYSTEMS/codex/releases"
  fi
fi
...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "product" "nameShort" "CodeEX - Insiders"
  setpath "product" "nameLong" "CodeEX - Ageixtic IDE - Insiders"
  ...
  setpath "product" "darwinBundleIdentifier" "ai.terratech.codex.insiders"
  setpath "product" "win32AppUserModelId" "TerraTech.CodeEXInsiders"
  setpath "product" "win32DirName" "CodeEX Insiders"
  setpath "product" "win32MutexName" "codexinsiders"
  setpath "product" "win32NameVersion" "CodeEX Insiders"
  setpath "product" "win32RegValueName" "CodeEXInsiders"
  setpath "product" "win32ShellNameShort" "CodeEX Insiders"
  ...
  setpath "product" "tunnelApplicationName" "codex-insiders-tunnel"
  ...
  setpath "product" "nameShort" "CodeEX"
  setpath "product" "nameLong" "CodeEX - Ageixtic IDE"
  ...
  setpath "product" "darwinBundleIdentifier" "ai.terratech.codex"
  setpath "product" "win32AppUserModelId" "TerraTech.CodeEX"
  setpath "product" "win32DirName" "CodeEX"
  setpath "product" "win32MutexName" "codex"
  setpath "product" "win32NameVersion" "CodeEX"
  setpath "product" "win32RegValueName" "CodeEX"
  setpath "product" "win32ShellNameShort" "CodeEX"
...
replace 's|Microsoft Corporation|TerraTech Systems|' package.json

cp resources/server/manifest.json{,.bak}

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "resources/server/manifest" "name" "CodeEX - Insiders"
  setpath "resources/server/manifest" "short_name" "CodeEX - Insiders"
else
  setpath "resources/server/manifest" "name" "CodeEX"
  setpath "resources/server/manifest" "short_name" "CodeEX"
fi
...
replace 's|Microsoft Corporation|TerraTech Systems|' build/lib/electron.ts
replace 's|([0-9]) Microsoft|\1 TerraTech|' build/lib/electron.ts
...
if [[ "${OS_NAME}" == "linux" ]]; then
  ...
  # code.iss
  sed -i 's|https://code.visualstudio.com|https://github.com/TERRA-TECH-SYSTEMS/codex|' build/win32/code.iss
  sed -i 's|Microsoft Corporation|TerraTech Systems|' build/win32/code.iss
fi
