...
This guide will help you get started with CodeEX - TerraTech's VS Code fork with AGEIXTIC integration.
...
CodeEX can be installed on Windows, macOS, and Linux. Visit the [releases page](https://github.com/TERRA-TECH-SYSTEMS/codex/releases) for installation instructions.

## <a id="first-steps"></a>First Steps

After installing CodeEX, here are some first steps to get started:
...
CodeEX works just like Visual Studio Code, with key differences:

- It uses Open VSX for extensions by default instead of the Visual Studio Marketplace
- It includes built-in AGEIXTIC AI integration
...
- Explore the [documentation](https://github.com/TERRA-TECH-SYSTEMS/codex/blob/main/docs/index.md) for more details
- Join the [discussions](https://github.com/TERRA-TECH-SYSTEMS/codex/discussions) to ask questions and share tips
- Contribute to the [project](https://github.com/TERRA-TECH-SYSTEMS/codex/blob/main/CONTRIBUTING.md) if you're interested
